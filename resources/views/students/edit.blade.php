...
@section('title', 'تعديل الطالب: ' . $student->full_name)
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">تعديل الطالب: {{ $student->full_name }}</h3>
                ...
                <form action="{{ route('students.update', $student) }}" method="POST">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('first_name_ar') is-invalid @enderror" 
                                           id="first_name_ar" name="first_name_ar" value="{{ old('first_name_ar', $student->first_name_ar) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('middle_name_ar') is-invalid @enderror" 
                                           id="middle_name_ar" name="middle_name_ar" value="{{ old('middle_name_ar', $student->middle_name_ar) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('last_name_ar') is-invalid @enderror" 
                                           id="last_name_ar" name="last_name_ar" value="{{ old('last_name_ar', $student->last_name_ar) }}" 
                        ...
                        <!-- باقي الحقول بنفس نمط واجهة الإنشاء -->
                        <!-- بيانات ولي الأمر -->
                        <div class="row mt-4">
                            <div class="col-12">
                                <h5 class="bg-light p-2 mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('guardian_relation') is-invalid @enderror" 
                                           id="guardian_relation" name="guardian_relation" value="{{ old('guardian_relation', $student->guardian_relation) }}" 
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('allergies') is-invalid @enderror" 
                                           id="allergies" name="allergies" value="{{ old('allergies', $student->allergies) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('medical_notes') is-invalid @enderror" 
                                      ...
                                      placeholder="أي ملاحظات طبية مهمة">{{ old('medical_notes', $student->medical_notes) }}</textarea>
                            @error('medical_notes')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('enrollment_date') is-invalid @enderror" 
                                           id="enrollment_date" name="enrollment_date" value="{{ old('enrollment_date', $student->enrollment_date->format('Y-m-d')) }}" 
                                           required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('enrollment_type') is-invalid @enderror" 
                                        ...
                                        <option value="new" {{ old('enrollment_type', $student->enrollment_type) == 'new' ? 'selected' : '' }}>جديد</option>
                                        <option value="transferred" {{ old('enrollment_type', $student->enrollment_type) == 'transferred' ? 'selected' : '' }}>منقول</option>
                                    </select>
