...
@section('title', 'تعديل الصف: ' . $grade->name_ar)
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">تعديل الصف: {{ $grade->name_ar }}</h3>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                           id="name_ar" name="name_ar" value="{{ old('name_ar', $grade->name_ar) }}" 
                                    ...
                                    <select class="form-control @error('stage_id') is-invalid @enderror" 
                                        ...
                                        @foreach($stages as $stage)
                                            <option value="{{ $stage->id }}" 
                                                {{ old('stage_id', $grade->stage_id) == $stage->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                           id="order" name="order" value="{{ old('order', $grade->order) }}" 
                                           min="1" max="12" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="أدخل وصفاً للصف">{{ old('description', $grade->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
