        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">إضافة مرحلة جديدة</h3>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                           ...
                                           min="0" placeholderسيتم تعيينه تلقائياً">
                                    <small class="form-text text-muted">اتركه فارغاً للتعيين التلقائي</small>
                                    @error('order')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('min_age') is-invalid @enderror" 
                                           id="min_age" name="min_age" value="{{ old('min_age') }}" 
                                           min="3" max="20" placeholder="أدخل الحد الأدنى للعمر">
                                    @error('min_age')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('max_age') is-invalid @enderror" 
                                           ...
                                           min="3" max="20" placeholder="أدخل الحد الأقصى للعمر">
                                    @error('max_age')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="أدخل وصفاً للمرحلة">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
