...
class UpdateTeacherRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'national_id' => ['required', 'string', 'max:20', Rule::unique('teachers')->ignore($teacherId)],
            ...
            'email' => ['required', 'email', 'max:255', Rule::unique('teachers')->ignore($teacherId)],
            'address' => ['nullable', 'string'],
            
            // المعلومات الوظيفية
            'employee_number' => ['required', 'string', 'max:50', Rule::unique('teachers')->ignore($teacherId)],
